(function (I, O) {
  typeof exports == 'object' && typeof module < 'u'
    ...
    : typeof define == 'function' && define.amd
      ? define(['exports'], O)
      : ((I = typeof globalThis < 'u' ? globalThis : I || self), O((I.UnicornStudio = {})));
})(this, function (I) {
  'use strict';
  var is = Object.defineProperty;
  var rs = (I, O, g) =>
    O in I ? is(I, O, { enumerable: !0, configurable: !0, writable: !0, value: g }) : (I[O] = g);
  ...
  let et = class {
    constructor(e) {
      if (((this.type = 'Scene'), !e || e.type !== 'Renderer'))
        C(this.type + ': Renderer not passed as first argument', e);
      else if (!e.gl) {
  ...
  class it {
    constructor({
      ...
      if (
        ((this.gl = this.canvas.getContext('webgl2', w)),
        (this._isWebGL2 = !!this.gl),
        this.gl ||
          (this.gl =
            this.canvas.getContext('webgl', w) || this.canvas.getContext('experimental-webgl', w)),
        this.gl)
      )
  ...
  class Ve {
    constructor(e, { parent: t, vertexShader: s, fragmentShader: i } = {}) {
      ...
      ((this.renderer = e),
        (this.gl = this.renderer.gl),
        (this.parent = t),
        (this.defaultVsCode = this.parent.type === 'Plane' ? ot : lt),
        (this.defaultFsCode = this.parent.type === 'Plane' ? ht : dt),
        s
          ? (this.vsCode = s)
          : (!this.renderer.production &&
        ...
        i
          ? (this.fsCode = i)
          : (this.renderer.production ||
              g(this.parent.type + ': No fragment shader provided, will use a default one'),
...
`);
        for (let o = 0; o < a.length; o++) a[o] = o + 1 + ': ' + a[o];
        return (
          (a = a.join(`
`)),
          g(
    ...
    useNewShaders() {
      ((this.vertexShader = this.createShader(this.vsCode, this.gl.VERTEX_SHADER)),
        ...
        (!this.vertexShader || !this.fragmentShader) &&
          (this.renderer.production ||
            g(this.type + ': Unable to find or compile the vertex or fragment shader')));
    }
    setupProgram() {
  ...
  class J {
    ...
    composeFromOrigin(e, t, s, i) {
      ...
      return (
        ...
        (r[11] = 0),
        (r[12] = e.x + $ - (Q * $ + R * B + q * W)),
        (r[13] = e.y + B - (y * $ + _ * B + re * W)),
        (r[14] = e.z + W - (b * $ + z * B + N * W)),
        (r[15] = 1),
        this
      );
    }
  ...
  class P {
    ...
    applyQuat(e) {
      const t = this._x,
        ...
        u = -r * t - a * s - o * i;
      return (
        (this._x = l * h + u * -r + d * -o - c * -a),
        (this._y = d * h + u * -a + c * -r - l * -o),
        (this._z = c * h + u * -o + l * -a - d * -r),
        this
      );
    }
    project(e) {
  ...
  class ne {
    constructor(
      ...
      if (
        ...
        (this._textureMatrix = { matrix: new J(), isActive: !1 }),
    ...
    _setParent() {
      if (
        ...
        if (!this._parent._program.compiled) {
          this.renderer.production ||
            g(this.type + ': Unable to create the texture because the program is not valid');
          return;
        }
        ...
        this._parent.type === 'RenderTarget' &&
          ((this._size = {
            width:
              (this._parent._size && this._parent._size.width) || this.renderer._boundingRect.width,
            height:
    ...
    setSource(e) {
      ...
      if (this.sourceType === 'empty' || this.sourceType !== t)
        if (t === 'video') ((this._willUpdate = !1), (this.shouldUpdate = !0));
          ...
          this.renderer.production ||
            g(this.type + ': this HTML tag could not be converted into a texture:', e.tagName);
          return;
        }
      ((this.source = e),
        (this.sourceType = t),
    ...
    _updateTexParameters() {
      (this.index && this.renderer.state.activeTexture !== this.index && this._bindTexture(),
        this.parameters.wrapS !== this._state.wrapS &&
          (!this.renderer._isWebGL2 &&
            (!Z(this._size.width) || !Z(this._size.height)) &&
...
gl.CLAMP_TO_EDGE wrapping will be used instead`,
        ...
        this.parameters.generateMipmap &&
          ...
          this.source &&
          (!this.renderer._isWebGL2 && (!Z(this._size.width) || !Z(this._size.height))
...
gl.LINEAR filtering will be used instead`,
    ...
    _getSizes() {
      ...
      let h = 0,
        l = 0;
      return (
        o > a ? (l = Math.min(0, s - t * (1 / a))) : o < a && (h = Math.min(0, t - s * a)),
        {
          parentWidth: t,
          parentHeight: s,
          sourceWidth: i,
  ...
  class Be {
    constructor(e, t = 'anonymous') {
      if (
        ((this.type = 'TextureLoader'), (e = (e && e.renderer) || e), !e || e.type !== 'Renderer')
      )
        C(this.type + ': Renderer not passed as first argument', e);
      else if (!e.gl) {
        C(this.type + ': Renderer WebGL context is undefined', e);
    ...
    loadImage(e, t = {}, s, i) {
      ...
      (o.complete
        ? this._sourceLoaded(o, h, s)
        : o.decode
          ? o
              .decode()
              .then(this._sourceLoaded.bind(this, o, h, s))
              .catch(() => {
    ...
    loadVideo(e, t = {}, s, i) {
      ...
      (r.addEventListener('canplaythrough', h.load, !1),
        r.addEventListener('error', h.error, !1),
        r.readyState >= r.HAVE_FUTURE_DATA && s && this._sourceLoaded(r, o, s),
        r.load(),
        this._addToParent && this._addToParent(o, r, 'video'),
        'requestVideoFrameCallback' in HTMLVideoElement.prototype &&
          ((h.videoFrameCallback = o._videoFrameCallback.bind(o)),
          (o._videoFrameCallbackID = r.requestVideoFrameCallback(h.videoFrameCallback))));
    }
    loadVideos(e, t, s, i) {
  ...
  class gt {
    constructor(
      ...
      ((this._canDraw = !1),
        ...
        (h = parseInt(h)),
        (l = parseInt(l)),
        (this._geometry = new ct(this.renderer, { width: h, height: l })),
...
`,
  ...
  class xt {
    constructor({
      ...
      ((this.position = new P()),
        ...
        (this.worldMatrix = new J()),
        (this.viewMatrix = new J()),
    ...
    updateProjectionMatrix() {
      ...
      this.projectionMatrix.setFromArray([h, 0, 0, 0, 0, l, 0, 0, d, c, u, -1, 0, 0, f, 0]);
    }
    forceUpdate() {
  ...
  class be {
    ...
    setFromVec3(e) {
      ...
      return (
        this.axisOrder === 'XYZ'
          ? ((this.elements[0] = h * a * o + r * l * d),
            (this.elements[1] = r * l * o - h * a * d),
            (this.elements[2] = r * a * d + h * l * o),
            (this.elements[3] = r * a * o - h * l * d))
          : this.axisOrder === 'YXZ'
            ? ((this.elements[0] = h * a * o + r * l * d),
              (this.elements[1] = r * l * o - h * a * d),
              (this.elements[2] = r * a * d - h * l * o),
  ...
  class He extends _t {
    constructor(
      ...
      t,
      {
        ...
        visible: v = !0,
        transparent: T = !1,
        drawCheckMargins: w = { top: 0, right: 0, bottom: 0, left: 0 },
        autoloadSources: E = !0,
        watchScroll: M = !0,
        fov: A = 50,
      } = {},
    ...
    _getNearPlaneIntersections(e, t, s) {
      ...
      if (s.length === 1)
        s[0] === 0
          ? ((t[0] = this._getIntersection(t[1], G.set(0.95, 1, 0).applyMat4(i))),
            t.push(this._getIntersection(t[3], j.set(-1, -0.95, 0).applyMat4(i))))
          : s[0] === 1
            ? ((t[1] = this._getIntersection(t[0], G.set(-0.95, 1, 0).applyMat4(i))),
              t.push(this._getIntersection(t[2], j.set(1, -0.95, 0).applyMat4(i))))
            : s[0] === 2
              ? ((t[2] = this._getIntersection(t[3], G.set(-0.95, -1, 0).applyMat4(i))),
                t.push(this._getIntersection(t[1], j.set(1, 0.95, 0).applyMat4(i))))
              : s[0] === 3 &&
                ((t[3] = this._getIntersection(t[2], G.set(0.95, -1, 0).applyMat4(i))),
                t.push(this._getIntersection(t[0], j.set(-1, 0.95, 0).applyMat4(i))));
      else if (s.length === 2)
        s[0] === 0 && s[1] === 1
          ? ((t[0] = this._getIntersection(t[3], G.set(-1, -0.95, 0).applyMat4(i))),
            (t[1] = this._getIntersection(t[2], j.set(1, -0.95, 0).applyMat4(i))))
          : s[0] === 1 && s[1] === 2
            ? ((t[1] = this._getIntersection(t[0], G.set(-0.95, 1, 0).applyMat4(i))),
              (t[2] = this._getIntersection(t[3], j.set(-0.95, -1, 0).applyMat4(i))))
            : s[0] === 2 && s[1] === 3
              ? ((t[2] = this._getIntersection(t[1], G.set(1, 0.95, 0).applyMat4(i))),
                (t[3] = this._getIntersection(t[0], j.set(-1, 0.95, 0).applyMat4(i))))
              : s[0] === 0 &&
                s[1] === 3 &&
                ((t[0] = this._getIntersection(t[1], G.set(0.95, 1, 0).applyMat4(i))),
                (t[3] = this._getIntersection(t[2], j.set(0.95, -1, 0).applyMat4(i))));
      else if (s.length === 3) {
        let r = 0;
        for (let a = 0; a < e.length; a++) s.includes(a) || (r = a);
        ((t = [t[r]]),
          r === 0
            ? (t.push(this._getIntersection(t[0], G.set(-0.95, 1, 0).applyMat4(i))),
              t.push(this._getIntersection(t[0], j.set(-1, 0.95, 0).applyMat4(i))))
            : r === 1
              ? (t.push(this._getIntersection(t[0], G.set(0.95, 1, 0).applyMat4(i))),
                t.push(this._getIntersection(t[0], j.set(1, 0.95, 0).applyMat4(i))))
    ...
    _getWorldCoords() {
      ...
      for (let h = 0; h < t.length; h++) {
        const l = t[h];
        (l.x < i && (i = l.x), l.x > r && (r = l.x), l.y < a && (a = l.y), l.y > o && (o = l.y));
      }
      return { top: o, right: r, bottom: a, left: i };
    }
    ...
    mouseToPlaneCoords(e) {
      if (
        (Ne.setAxisOrder(this.quaternion.axisOrder),
        Ne.equals(this.quaternion) && Et.equals(this.transformOrigin))
      )
        return super.mouseToPlaneCoords(e);
      {
        ...
        if (Math.abs(o) >= 1e-4) {
          ...
          const c = r.dot(l.clone().sub(s)) / o;
          (a.copy(s.add(i.multiplyScalar(c))), a.applyMat4(h));
    ...
    _createFrameBuffer() {
      ((this._frameBuffer = this.gl.createFramebuffer()),
        ...
        this.textures.length
          ...
          : new ne(this.renderer, this._texturesOptions).addParent(this),
  ...
  typeof document.hidden < 'u'
    ? ((Pe = 'hidden'), (ue = 'visibilitychange'))
    : typeof document.msHidden < 'u'
      ? ((Pe = 'msHidden'), (ue = 'msvisibilitychange'))
      : typeof document.webkitHidden < 'u' &&
        ((Pe = 'webkitHidden'), (ue = 'webkitvisibilitychange'));
  function It(n, e) {
    let t;
    return function (...s) {
      (clearTimeout(t),
  ...
  function Ie(n, e, t, s, i) {
    if (t.length > 1) {
      ...
      if (i === 'radial') {
        ...
        d = n.createRadialGradient(a, o, f, a, o, 0);
      }
      const c = Math.cos(r) * h,
        u = Math.sin(r) * l;
      if (
        (i === 'linear' && (d = n.createLinearGradient(a - c, o - u, a + c, o + u)), i === 'conic')
      ) {
        d = n.createConicGradient(-Math.PI + r, a, o);
  ...
  function je(n, e) {
    ...
    let t = n.widthMode === 'fixed' ? n.width : n.width * e.offsetWidth,
      ...
      o = n.topMode === 'fixed' ? n.top : n.top * e.offsetHeight,
      h = n.leftMode === 'fixed' ? n.left : n.left * e.offsetWidth,
      l = ce(n.anchorPoint);
    ...
    (c.setAttribute('data-us-text', n.local.id),
      (c.style.cssText = `width:${t}px;top:${o}px;left:${h}px;font-size:${i}px;line-height:${r}px;letter-spacing:${a}px;font-family:${n.fontFamily};font-weight:${n.fontWeight};text-align:${n.textAlign};position:absolute;word-break:break-word;transform:rotateZ(${Math.round(n.rotation * 360)}deg);color:transparent;z-index:2;`),
  ...
  function Ot(n) {
    return (
      n && n.renderer && n.renderer.nextRender && typeof n.renderer.nextRender.execute == 'function'
    );
  }
  function Te() {
    ...
    const e = (t) => {
      ...
      (n.forEach((i) => {
        i.isInView && i.initialized
          ? ((i.rendering = !0),
            t - (i.lastTime || 0) >= i.frameDuration &&
              !i.paused &&
              (i.renderFrame(), (i.lastTime = t)),
            (s = !0))
          : (i.rendering = !1);
      }),
        (!fe || t - fe > 64) &&
          ...
          (fe = t),
          (oe > 1e3 || (oe < 0 && !Fe && !X)) && Le()),
        s ? (Yt(), (he = requestAnimationFrame(e))) : cancelAnimationFrame(he));
    };
    n.length ? (he = requestAnimationFrame(e)) : cancelAnimationFrame(he);
  }
  function _e(n, e, t) {
  ...
  function Re(n, e) {
    return (
      n.type === 'Vec2'
        ? (n = new k(n._x, n._y))
        : n.type === 'Vec3' && (n = new P(n._x, n._y, n._z)),
      n
    );
  }
  function Ee(n, e, t) {
  ...
  class Ut {
    constructor({
      ...
      ((this.prop = e),
        ...
        (this.uniformData = a),
        (this.value = Re(t)),
        (this.endValue = s !== void 0 ? Re(s || 0) : null),
        ...
        (this.loop = o),
        (this.loopDelay = h),
        (this.easeFunction = Ge(this.transition.ease)));
    }
    updateEffect(e, t) {
      ...
      if (r < 0) return !1;
      if (this.loop !== 'none') {
        const o = this.transition.duration + this.loopDelay,
          h = r % o;
        if (h > this.transition.duration) return !1;
        const l = h / this.transition.duration,
          d = Math.floor(r / o);
        let c = l;
        return (
          this.loop === 'reverse' && d % 2 === 1 && (c = 1 - l),
          (this.progress = this.easeFunction(c)),
          (this.lastTick = s),
          _e(this.value, e, this.progress)
        );
      }
      ...
      return (
        ...
        this.progress === 0
          ...
          : (a >= 1 && ((this.complete = !0), (this.progress = 0)),
            (this.lastTick = s),
            this.complete ? !1 : _e(this.value, e, this.progress))
      );
    }
    resetState() {
      ((this.progress = 0),
  ...
  class Vt {
    ...
    updateEffect(e, { top: t, height: s, isFixed: i }) {
      ...
      if ((i && (t -= X), this.mode === 'scrollIntoView')) {
        ...
        return this.lastTick !== void 0 &&
          ((h = we(h, this.lastTick, this.momentum * 2)), Math.abs(this.lastTick - h) < pe)
          ? !1
          : ((this.lastTick = h), _e(e, this.value, h));
      } else if (this.mode === 'whileScrolling') {
        let r = oe * this.delta;
        return (
          this.absScrollValue && (r = Math.abs(r)),
          this.lastTick !== void 0 &&
          ((r = we(r, this.lastTick, this.momentum * 2)), Math.abs(r) < pe)
            ? !1
            : ((this.lastScrollPos = X), (this.lastTick = r), _e(e, this.value, r))
        );
      }
      return !1;
    }
  ...
  class Bt {
    ...
    updateEffect(e, t, s) {
      ...
      const a = t === null,
        o = a ? this.lastTick || r : t + this.transition.delay,
        h = (r - o) / this.transition.duration,
      ...
      return (
        ...
        !t && !c
          ...
          : (!t && this.transition.forwardsOnly && ((this.progress = 0), (this.rawProgress = 0)),
            ...
            c ? _e(e, this.value, this.progress) : !1)
      );
    }
    resetState() {
      this.progress = 0;
      ...
      n.forEach((e) => {
        ...
        for (let i in e.props)
          ((t = e.props[i]) == null ? void 0 : t.type) === 'Vec2'
            ? (e.props[i] = new k(e.props[i]._x, e.props[i]._y))
            : ((s = e.props[i]) == null ? void 0 : s.type) === 'Vec3'
              ? (e.props[i] = new P(e.props[i]._x, e.props[i]._y, e.props[i]._z))
              : typeof e.props[i] == 'object' && (e.props[i] = te(e.props[i]));
      }),
      n
    );
  }
  class Ye {
    ...
    getPlane() {
      var e, t, s;
      return (s =
        (t = (e = this.state()) == null ? void 0 : e.curtain) == null ? void 0 : t.planes) == null
        ? void 0
    ...
    getPlanes() {
      var e, t, s;
      return (
        ((s = (t = (e = this.state()) == null ? void 0 : e.curtain) == null ? void 0 : t.planes) ==
        null
          ? void 0
    ...
    getChildEffectItems() {
      if (this.effects && this.effects.length) {
        ...
        return this.effects
          .map((i) => t.find((r) => r.parentLayer === i))
          .filter((i) => i !== void 0);
      } else return [];
    }
    setBreakpointValues() {
      ...
      for (let r = t.length - 1; r >= 0; r--) {
        ...
        if (a.max === null || e <= a.max)
          for (let o in a.props) s.hasOwnProperty(o) || (s[o] = a.props[o]);
      }
    ...
    updateStateEffects() {
      ...
      if (
        ...
        !((i = this.states) != null && i.scroll.length) &&
        !((r = this.states) != null && r.hover.length)
      )
        return;
      ...
      (!this.local.cachedBreakpoint ||
        ...
        (this.local.cachedBreakpoint = (o = e.currentBreakpoint) == null ? void 0 : o.name);
      const s = (h) =>
        !h.breakpoints || h.breakpoints.length === 0
          ? !0
          : h.breakpoints.find((l) => l === this.local.cachedBreakpoint);
      (e.isInView &&
        (this.local.createdAt === null && (this.local.createdAt = t),
        this.states.appear.forEach((h) => {
          if (!s(h)) return;
          let l = h.startTime || this.local.createdAt;
          if (!h.initialized) {
            const c = [...this.states.appear.filter((u) => u.prop === h.prop)].sort(
              (u, f) => (u.transition.delay || 0) - (f.transition.delay || 0),
            )[0];
            ((c == null ? void 0 : c.id) === h.id &&
          ...
          const d = h.updateEffect(this[h.prop], l);
          (d !== !1 &&
            ((this.local.uniformUpdatesPool[h.prop] = d),
            (this.local.hasUpdates = !0),
            this.local.updatedProps.add(h.prop)),
        ...
        this.states.hover.forEach((h) => {
          if (!s(h)) return;
          const l = h.updateEffect(this[h.prop], e.mouse.enterTime, this);
          l !== !1 &&
        ...
        this.states.scroll.forEach((h) => {
          ...
          const l = e.bbox;
          if (!l) return;
          const d = h.updateEffect(this[h.prop], {
        ...
        this.local.hasUpdates &&
          (this.getPlanes().forEach((h) => {
            ...
            for (let d of this.local.updatedProps) {
              ...
              c !== void 0 &&
                ((l = h.uniforms[d]) == null ? void 0 : l.lastValue) !== c &&
                (h.uniforms[d] && Ee(c, h.uniforms[d], d), this.updateStateEffectProperty(d, c));
            }
          }),
          this.isElement &&
    ...
    removeStateEffectProperty(e) {
      this.local.stateEffectProps &&
        this.local.stateEffectProps[e] &&
        delete this.local.stateEffectProps[e];
    }
  ...
  let ze = class extends Ye {
    ...
    unpackage() {
      return (
        ...
        (this.maskBackground = new P(
          this.maskBackground._x,
          this.maskBackground._y,
          this.maskBackground._z,
        )),
        this.unpackageType(),
        this
      );
    ...
    getAbsolutePosition() {
      ...
      const t = this.state(),
        ...
        i = t.canvasHeight;
      let r =
          ((d = (l = this.local) == null ? void 0 : l.stateEffectProps) == null
            ? void 0
            : d.left) ?? this.left,
        a =
          ((u = (c = this.local) == null ? void 0 : c.stateEffectProps) == null ? void 0 : u.top) ??
          this.top,
        o = this.leftMode === 'fixed' ? r : r * s,
        h = this.topMode === 'fixed' ? a : a * i;
      return ((o = +o.toFixed(1)), (h = +h.toFixed(1)), { left: o, top: h });
    }
    getAbsoluteDimensions() {
      ...
      let o =
          ((d = (l = this.local) == null ? void 0 : l.stateEffectProps) == null
            ...
            : d.width) ?? this.width,
        h =
          ((u = (c = this.local) == null ? void 0 : c.stateEffectProps) == null
            ? void 0
            : u.height) ?? this.height;
      return (
        this.widthMode !== 'auto' &&
          ((s = this.widthMode === 'fixed' ? o : o * r),
          this.heightMode === 'auto' &&
            ((i = s / (this.aspectRatio || 1)),
            (this.height = this.widthMode === 'fixed' ? i : i / a))),
        this.heightMode !== 'auto' &&
          ((i = this.heightMode === 'fixed' ? h : h * a),
          this.widthMode === 'auto' &&
            ((s = i * (this.aspectRatio || 1)),
            (this.width = this.widthMode === 'fixed' ? s : s / r))),
    ...
    isHovered() {
      ...
      (i < 0 && (i = Math.abs(i)),
        r < 0 && ((s = s + r), (r = Math.abs(r))),
        (t = t - a.x * i),
        (s = s - a.y * r));
      let o = this.state().mouse.movePos;
      return o.x * 2 >= t && o.x * 2 <= t + i && o.y * 2 >= s && o.y * 2 <= s + r;
    }
  };
  class Nt extends ze {
    constructor(t, s, i) {
    ...
    render() {
      ...
      const s = this.state();
      let { left: i, top: r, width: a, height: o } = this.box();
      const h = ce(this.anchorPoint);
      let l =
          ((m = this.local.stateEffectProps) == null ? void 0 : m.borderRadius) ??
          this.borderRadius,
        d =
          ((v = this.local.stateEffectProps) == null ? void 0 : v.strokeWidth) ?? this.strokeWidth,
        c =
          ((T = this.local.stateEffectProps) == null ? void 0 : T.gradientAngle) ??
          this.gradientAngle,
      ...
      if ((t.clearRect(0, 0, s.canvasWidth, s.canvasHeight), t.beginPath(), this.fitToCanvas))
        ...
        if (
          (t.save(),
          t.translate(f + a / 2, p + o / 2),
          t.rotate(u * 2 * Math.PI),
          t.translate(-a / 2, -o / 2),
          this.type === 'rectangle')
        ) {
          let E = (l * Math.min(Math.abs(a), Math.abs(o))) / 2;
          this.drawRoundedRect(t, 0, 0, a, o, E);
        } else
          this.type === 'circle'
            ? t.ellipse(a / 2, o / 2, Math.abs(a) / 2, Math.abs(o) / 2, 0, 0, 2 * Math.PI)
            : this.type === 'polygon' &&
              this.drawPolygon(t, Math.abs(a), Math.abs(o), this.numSides);
        t.fillStyle = Ie(t, this.box(), this.fill, c, this.gradientType);
      }
      (t.fill(),
        d && ((t.strokeStyle = this.stroke[0]), (t.lineWidth = d), t.stroke()),
        t.restore());
    }
    drawRoundedRect(t, s, i, r, a, o) {
      (t.beginPath(),
        t.moveTo(s + o, i),
        t.arcTo(s + r, i, s + r, i + a, o),
        t.arcTo(s + r, i + a, s, i + a, o),
        t.arcTo(s, i + a, s, i, o),
        t.arcTo(s, i, s + r, i, o),
        t.closePath());
    }
    drawPolygon(t, s, i, r) {
      t.beginPath();
      for (let a = 0; a < r; a++) {
        const o = (a * 2 * Math.PI) / r - Math.PI / 2,
          h = s * Math.cos(o),
          l = i * Math.sin(o);
        a === 0 ? t.moveTo(h, l) : t.lineTo(h, l);
      }
      t.closePath();
    }
  }
    ...
    unpackage() {
      for (let t in this)
        this[t] &&
          this[t].type &&
          (this[t].type === 'Vec2'
            ? (this[t] = new k(this[t]._x, this[t]._y))
  ...
  class Gt extends ze {
    ...
    renderImage() {
      ...
      if (this.fitToCanvas) {
        ...
        h / l < u ? ((o = l), (a = l * u)) : ((a = h), (o = h / u));
        const p = (h - a) / 2,
          m = (l - o) / 2;
        t.drawImage(this.local.img, p, m, a, o);
      } else {
        const u = ce(this.anchorPoint),
          f =
            (((c = this.local.stateEffectProps) == null ? void 0 : c.rotation) ?? this.rotation) *
            2 *
            Math.PI;
        let p = u.x * a,
          m = u.y * o;
        ...
        let v = a / 2,
          ...
          w = i - p + v,
          E = r - m + T;
        (t.translate(w, E), t.rotate(f), t.drawImage(this.local.img, -v, -T, a, o), t.restore());
      }
    }
    render() {}
  }
  class jt extends ze {
    ...
    loadFont() {
      ...
      if (
        ...
        !((h = this.fontCSS) != null && h.src)
      ) {
        this.handleFontLoaded();
        return;
      }
      let a = this.fontCSS.src.split(' ').join('%20');
      const o = new FontFace(this.fontFamily, `url(${a})`, {
        style: t,
        weight: i,
      });
    ...
    getAbsoluteFontValues(t) {
      var o, h, l, d, c, u;
      const s =
          ((h = (o = this.local) == null ? void 0 : o.stateEffectProps) == null
            ? void 0
            : h.fontSize) || this.fontSize,
        i =
          ((d = (l = this.local) == null ? void 0 : l.stateEffectProps) == null
            ? void 0
        ...
        r =
          ((u = (c = this.local) == null ? void 0 : c.stateEffectProps) == null
            ? void 0
            : u.letterSpacing) || this.letterSpacing,
    ...
    render() {
      ...
      const a = ce(this.anchorPoint),
        o =
          ((Q = (W = this.local) == null ? void 0 : W.stateEffectProps) == null
            ? void 0
      ...
      let h = this.state(),
        ...
        c = i - a.y * l,
        u = 0,
        { fontSize: f, lineHeight: p, letterSpacing: m } = this.getAbsoluteFontValues(h),
        v = this.fontStyle.includes('italic') ? 'italic' : 'normal',
        T = /^\d+$/.test(this.fontStyle) ? this.fontStyle : '400';
      (t.clearRect(0, 0, h.canvasWidth, h.canvasHeight),
        (t.font = `${v} ${T} ${f}px/${p}px ${this.fontFamily}, -apple-system, BlinkMacSystemFont, Helvetica, Arial`),
      ...
      let E = d + r / 2,
        M = c + l / 2;
      (t.translate(E, M),
        t.rotate((o * 360 * Math.PI) / 180),
        t.translate(-E, -M),
        this.textAlign === 'center' && (d += r / 2),
        this.textAlign === 'right' && (d += r),
        (t.fillStyle = Ie(t, this.box(), this.fill, this.gradientAngle, this.gradientType)));
      const A = (y, b, R, _, z, q, re) => {
          let N = b
              .split('')
              .reduce((L, ee, ss) => L + y.measureText(ee).width + (ss < b.length - 1 ? z : 0), 0),
            H;
          if ((q === 'center' ? (H = R + (re - N) / 2 - re / 2) : (H = R), q === 'right'))
            ...
            for (let L = 0; L < b.length; L++)
              (y.fillText(b[L], H, _), (H += y.measureText(b[L]).width + z));
        },
        F = (y, b) => {
          let R = c + p * b + p / 2 + f / 3;
...
`)
      ...
      const $ = (y, b, R) =>
        b
          .split('')
          .reduce(
            (z, q, re) => ((z += y.measureText(q).width), re < b.length - 1 && (z += R), z),
            0,
          );
      for (let y = 0; y < V; y++) {
        let b = '',
        ...
        for (let _ = 0; _ < R.length; _++) {
          const z = R[_],
            q = b + z;
          if (
            (this.isSafari && m ? $(t, q, m) : t.measureText(q).width) > r ||
            z ===
              `
`
          ) {
            if (b !== '')
              ((x[y] = b.trim()),
                _ !== R.length - 1
                  ? (x.splice(y + 1, 0, R.slice(_).join('')), V++)
                  : z !==
                      `
` && x.push(z));
            else {
              ...
              for (; N.length > 0; ) {
                ...
                for (
                  let ee = 0;
                  ee < N.length && (t.measureText(L + N[ee]).width <= r || ee == 0);
                  ee++
                )
                  L += N[ee];
                ((N = N.slice(L.length)),
                  (x[H] = L.trim()),
                  N.length > 0 && (x.splice(H + 1, 0, N), H++, V++));
              }
  ...
  function $e() {
    ...
    document[Pe]
      ...
      : (Te(),
        S.forEach((e) => {
          ((e.pauseTime = e.pauseTime - n),
            e.curtain.planes.forEach((t) => {
              t.videos.forEach((s) => {
                s.play();
              });
            }));
  ...
  function qe(n, e, t = 50) {
    const s = e || n.getBoundingClientRect(),
      i =
        (s.top >= -t && s.top <= ae + t) ||
        (s.bottom >= -t && s.bottom <= ae + t) ||
        (s.top <= 0 && s.bottom >= ae),
      r =
        (s.left >= -t && s.left <= K + t) ||
        (s.right >= -t && s.right <= K + t) ||
        (s.left <= 0 && s.right >= K);
    return i && r;
  }
  function Le() {
    S.filter((n) => n.getDynamicLayers().length).forEach((n) => {
      ...
      ((n.scrollY = X),
        n.lastBbox &&
          (Math.abs(e.top - n.lastBbox.top) === 0 && oe > 0
  ...
  function Yt() {
    ...
    S.forEach((e) => {
      ...
      if (
        e.isInView &&
        (s = (t = e.curtain) == null ? void 0 : t.planes) != null &&
        s.find((h) => h.uniforms.mousePos) &&
        !(
          (ve() &&
            (r = (i = e.interactivity) == null ? void 0 : i.mouse) != null &&
            r.disableMobile) ||
          ((o = (a = e.interactivity) == null ? void 0 : a.mouse) != null && o.disabled)
        )
      ) {
        ((e.mouse.pos.y = e.mouse.movePos.y),
          (e.mouse.pos.x = e.mouse.movePos.x),
          (e.mouse.lastPos.x = e.mouse.pos.x),
          (e.mouse.lastPos.y = e.mouse.pos.y));
        let h = e.isFixed ? e.bbox.top : e.bbox.top + e.scrollY,
          l = e.bbox.left;
        e.mouse.page.x > l &&
        e.mouse.page.y > h &&
        e.mouse.page.x < e.lastBbox.width + l &&
        e.mouse.page.y < e.lastBbox.height + h
          ? e.mouse.enterTime || (e.mouse.enterTime = n)
  ...
  function Se(n) {
    ...
    S.filter((t) => t.isInView && t.initialized).forEach((t) => {
      ...
      Math.abs(oe) > 1 &&
        e - t.lastBboxTime > 64 &&
        ((s = t.element.getBoundingClientRect()),
        (t.lastBbox = t.bbox),
        (t.bbox = s),
        (t.lastBboxTime = e));
      let i, r;
      (n.targetTouches
        ...
        : ((i = n.pageX), (r = n.pageY)),
        t.isFixed &&
          ((t.scrollY = 0), n.targetTouches ? (r = n.targetTouches[0].clientY) : (r = n.clientY)));
      const a = i - s.left,
        o = r - (s.top + (t.isFixed ? 0 : X));
      ((t.mouse.page.x = i),
        (t.mouse.page.y = r),
        (t.mouse.movePos.x = a * 0.5),
        (t.mouse.movePos.y = o * 0.5),
        (t.mouse.movedInView = !0));
    });
  }
  let S = [];
  class $t {
    constructor(e) {
      D(this, 'local', { preloadedTextures: {} });
      D(this, 'scrollY', 0);
      D(this, 'paused', !1);
      ...
      ((this.id = e.id),
        ...
        (this.canvasWidth = e.width || e.element.offsetWidth || K),
        (this.canvasHeight = e.height || e.element.offsetHeight || ae),
        (this.curtain = void 0),
        ...
        (this.currentBreakpoint = this.breakpoints.find((t) => K >= t.min && K <= t.max)),
        this.createCurtains(),
        this.setCanvasScale(),
      ...
      this.layers.forEach((e) => {
        ...
        if (e.isElement)
          ...
          const c =
              ...
              ((o = (a = e == null ? void 0 : e.data) == null ? void 0 : a.texture) == null
                ? void 0
                : o.src),
            u =
              ((h = e == null ? void 0 : e.texture) == null ? void 0 : h.sampler) ||
              ((d = (l = e == null ? void 0 : e.data) == null ? void 0 : l.texture) == null
                ? void 0
                : d.sampler) ||
              'uTexture';
          this.local.preloadedTextures[c]
            ? this.local.preloadedTextures[c].count++
            : ((this.local.preloadedTextures[c] = { count: 1, texture: null }),
              this.textureLoader.loadImage(c, { sampler: u, premultipliedAlpha: !1 }, (f) => {
    ...
    destroy() {
      var t, s;
      ((t = this.curtain) != null && t.gl && (this.curtain.dispose(), (this.curtain = null)),
        this.element &&
          (this.element.removeAttribute('data-us-initialized'),
          this.element.removeAttribute('data-scene-id'),
          (s = this.element.querySelector('canvas')) == null || s.remove(),
          this.element.querySelectorAll('[data-us-text]').forEach((i) => {
            i.remove();
          })),
        this.layers.filter((i) => i.dispose).forEach((i) => i.dispose()),
        (this.layers = []));
    ...
    resize() {
      (this.setCanvasScale(),
        ...
        (this.lastBbox = this.bbox),
        (this.bbox = this.element.getBoundingClientRect()),
        (this.currentBreakpoint = this.breakpoints.find((e) => K >= e.min && K <= e.max)),
        this.curtain &&
          (this.curtain.resize(),
    ...
    createCurtains() {
      ...
      (this.curtain.onError((e) => {
        ...
        this.curtain.onContextRestored(() => {
          (console.log('Unicorn.studio scene restored WebGL context'),
            this.initialized &&
              (this.layers.forEach((e) => {
                e.preloadedCanvasTexture && (e.preloadedCanvasTexture.shouldUpdate = !0);
              }),
      ...
      if (s) {
        let i = s.parentLayer ? s.getParent() : null,
          ...
          a =
            ...
            i.effects &&
            i.effects.length &&
            i.getChildEffectItems().filter((o) => de(o)).length;
        for (; s && !de(s) && !r && !a; )
          (t++,
            (s = e[t]),
            s &&
    ...
    getPlanes() {
      var e;
      return (e = this.curtain) == null
        ? void 0
        : e.planes.filter((t) => t.type !== 'PingPongPlane');
    }
    getPlaneParams(e, t) {
      var o, h, l, d, c;
      let s =
        ((o = e.data) != null && o.heightSegments) || ((h = e.data) != null && h.widthSegments)
          ? 500
          : 1;
      const i = {
        resolution: {
        ...
        mousePos: { name: 'uMousePos', type: '2f', value: new k(0.5) },
      ...
      if (
        (e.states &&
          [...e.states.appear, ...e.states.scroll, ...e.states.hover].forEach((u) => {
            i[u.prop] ||
              (u.uniformData && ((i[u.prop] = u.uniformData), (i[u.prop].value = e[u.prop])));
          }),
        (l = e.data) != null && l.uniforms)
      )
        for (let u in e.data.uniforms) {
          let f = e.data.uniforms[u];
          ((i[u] = e.data.uniforms[u]),
            ((d = f.value) == null ? void 0 : d.type) === 'Vec3'
              ? (i[u].value = new P(f.value._x, f.value._y, f.value._z))
              : ((c = f.value) == null ? void 0 : c.type) === 'Vec2'
                ? (i[u].value = new k(f.value._x, f.value._y))
                : typeof f.value == 'object' && (i[u].value = te(f.value)));
        }
      return {
        fragmentShader: r,
        vertexShader: a,
      ...
      try {
        ...
        let o =
            ...
            ((s == null ? void 0 : s.index) === 0 &&
              ((a = e.data) == null ? void 0 : a.downSample)),
          h = this.renderingScale;
        if (
          (o && ((h = typeof o == 'number' ? o : 0.5), (h *= this.renderingScale)),
          e.userDownsample && typeof e.userDownsample == 'number' && (h *= e.userDownsample),
        ...
        return (
          ...
          (r.userData.downSample = h),
          r.setRenderOrder(t),
          r
        );
      } catch (o) {
        return (console.error('Error creating plane:', o), null);
      }
    }
    createPingPongPlane(e, t, s) {
      ...
      let i = this.getPlaneParams(e, 1 + ((s == null ? void 0 : s.length) || 0)),
        r =
          (a = this.curtain) == null
            ? void 0
            : a.planes.find((o) => o.type === 'PingPongPlane' && o.userData.id === e.local.id);
      if (r) r.setRenderOrder(t);
        ...
        ((r.userData.id = e.local.id),
          ...
          r
            .onReady(() => {
              (this.setInitialEffectPlaneUniforms(r, e, e == null ? void 0 : e.getParent(), s),
    ...
    createEffectPlane(e, t, s) {
      ...
      (s &&
        ...
        Object.entries(s).forEach(([a, o]) => {
          i.uniforms[a] && (i.uniforms[a].value = o);
        })),
      ...
      if (
        ([t.texture, (i = t.data) == null ? void 0 : i.texture]
          ...
          .forEach((r) => {
            var o;
            if (
              (o = t.compiledFragmentShaders[s.passIndex ?? 0]) == null
                ? void 0
                : o.includes(r.sampler)
            ) {
              const h = this.local.preloadedTextures[r.src];
              h != null && h.texture
                ? (h.count > 1 ? (U(e, r.sampler, h.texture), h.count--) : e.addTexture(h.texture),
                  (e.userData.textureLoaded = !0))
                : this.textureLoader.loadImage(
                    r.src,
                    { premultipliedAlpha: !1, sampler: r.sampler },
                    (l) => {
        ...
        e.loadVideo(r, { premultipliedAlpha: !0, sampler: 'uVideoTexture' }, (a) => {
          ((e.videos.at(-1).loop = t.hasOwnProperty('loop') ? t.loop : !0),
    ...
    handleEffectPlane(e, t, s) {
      ...
      let r = this.getRenderTargets()[t - 1],
        a =
          (h = this.curtain) == null
            ? void 0
            : h.planes.find((l) => l.type === 'PingPongPlane' && l.userData.id === e.local.id),
        o = e.compiledFragmentShaders[s.passIndex ?? 0];
      if (
        (a &&
          o != null &&
          o.includes('uPingPongTexture') &&
          U(i, 'uPingPongTexture', a.getTexture()),
        r ? U(i, 'uTexture', r.getTexture()) : U(i, 'uTexture'),
    ...
    handleElementPlane(e, t) {
      ...
      let a = this.getRenderTargets()[t - 1],
        ...
        h;
      if (
        (e.mask && o && (h = o.local.lastTarget),
        i.length || (s.textures.length = 0),
        a && i.length
          ? U(s, 'uTexture', a.getTexture())
          : s && s.addTexture(e.preloadedCanvasTexture),
        a)
      ) {
        if (i.length) {
        ...
        a &&
          (U(s, 'uBgTexture', a.getTexture()),
          h && e.mask && U(s, 'uPreviousLayerTexture', h.getTexture()));
      }
    }
    handleChildEffectPlane(e, t, s) {
      ...
      let a = this.getRenderTargets()[t - 1],
        ...
        l = r.effects.filter((p) => {
          if (this.layers.find((m) => m.parentLayer === p))
            return this.layers.find((m) => m.parentLayer === p);
        }),
      ...
      if (
        (a && (d || s.passIndex > 0)
          ? (e.isMask && (!s.length || (c && u)) && i.addTexture(r.preloadedCanvasTexture),
            U(i, 'uTexture', a.getTexture()))
          : e.isMask
            ? (c && u && i.addTexture(r.preloadedCanvasTexture),
              a ? U(i, 'uTexture', a.getTexture()) : U(i, 'uTexture'))
            : h != null &&
              h.includes('uTexture') &&
              (i.addTexture(r.preloadedCanvasTexture),
              (r.preloadedCanvasTexture.userData.used = !0)),
        o &&
          h != null &&
          h.includes('uPingPongTexture') &&
          U(i, 'uPingPongTexture', o.getTexture()),
        ...
        if (d && s.length > 1) {
          ...
          r.preloadedCanvasTexture.userData.used
            ...
            : ((r.preloadedCanvasTexture._samplerName = 'uBgTexture'),
              i.addTexture(r.preloadedCanvasTexture));
      (e.type === 'custom' && U(i, 'uCustomTexture', this.getRenderTargets()[t]),
        this.handleMediaTextures(i, e, s));
    }
    createPlanes() {
    ...
    setInitialEffectPlaneUniforms(e, t, s, i) {
      ...
      if (!e.userData.initialUniformsSet || !e.userData.isReady) {
        for (let a in e.uniforms)
          ((r = t.states) != null && r.scroll.some((o) => o.prop === a)) ||
            (t.local.bpProps && a in t.local.bpProps
              ? Ee(t.local.bpProps[a], e.uniforms[a], a)
              : a in t && Ee(t[a], e.uniforms[a], a));
    ...
    setInitialElementPlaneUniforms(e, t) {
      ...
      for (let i in e.uniforms)
        t.local.bpProps && i in t.local.bpProps
          ...
          : i in t &&
            (e.uniforms[i].value =
              ((s = t.local.stateEffectProps) == null ? void 0 : s[i]) ?? t[i]);
      e.uniforms.sampleBg &&
        (e.renderOrder - t.effects.length === 0
    ...
    calculateItemMouseValues(e) {
      ...
      return (
        this.local.mouseValuePool || (this.local.mouseValuePool = new k(0.5)),
    ...
    getMousePosWithMomentum(e, t, s) {
      ...
      let d = i / t,
        c = 1 - r / s;
      if (!l) return { x: o ? d : 0.5, y: h ? c : 0.5 };
      if (!e.local.lastMousePos)
        return ((e.local.lastMousePos = { x: o ? d : 0.5, y: h ? c : 0.5 }), e.local.lastMousePos);
      ...
      return (
        (p < pe && m < pe) ||
          (o
            ? ((i = we(i, u, l * 2)), (e.local.lastMousePos.x = i / t))
            : (e.local.lastMousePos.x = 0.5),
          h
            ? ((r = we(r, f, l * 2)), (e.local.lastMousePos.y = 1 - r / s))
    ...
    setEffectPlaneUniforms(e, t) {
      ...
      if (
        ...
        (a = t.local.stateEffectProps) != null &&
          a.playbackRate &&
          e.videos.at(-1) &&
          (e.videos.at(-1).playbackRate = t.local.stateEffectProps.playbackRate),
        ve() &&
          (h = (o = this.interactivity) == null ? void 0 : o.mouse) != null &&
          h.disableMobile)
      )
        return !1;
      ...
      i &&
        (e.uniforms.previousMousePos &&
          (this.mouse.ticks > 16
            ...
            : ((e.uniforms.previousMousePos.value.x = i.x),
              (e.uniforms.previousMousePos.value.y = i.y))),
        e.uniforms.mousePos &&
    ...
    getTextureParams(e, t, s) {
      ...
      return (
        i.userData.downSample &&
          (r = typeof i.userData.downSample == 'number' ? i.userData.downSample : 0.5),
        {
          maxWidth: this.curtain.canvas.width * r,
          maxHeight: this.curtain.canvas.height * r,
          depth: (o = s == null ? void 0 : s.data) == null ? void 0 : o.depth,
        }
      );
    }
    handlePlaneCreation() {
    ...
    waitForAssetsAndDisablePlanes() {
      this.layers.some(
        (t) =>
          ...
          Object.values(this.local.preloadedTextures).some((s) => s && s.texture === null),
      )
        ? setTimeout(() => this.waitForAssetsAndDisablePlanes(), 64)
        : (this.layers
            .filter((t) => t.preloadedCanvasTexture)
            .forEach((t) => {
              t.preloadedCanvasTexture.shouldUpdate =
                t.preloadedCanvasTexture.userData.hasStateEffects || !1;
            }),
  ...
  function Qt() {
    (se(window, 'scroll', Qe),
      ve() ? se(window, 'touchmove', Se) : se(window, 'mousemove', Se),
      se(window, 'routeChange', Xe),
      se(document, 'mouseleave', Ze),
      (le = It(Xt, 16)),
      ve() ? se(window, 'orientationchange', le) : se(window, 'resize', le),
      se(document, ue, $e),
      (ke = !0));
  }
  function De() {
    (ie(window, 'mousemove', Se),
      ie(window, 'touchmove', Se),
      ie(window, 'scroll', Qe),
      ie(window, 'routeChange', Xe),
      ie(document, 'mouseleave', Ze),
      le && (ie(window, 'resize', le), ie(window, 'orientationchange', le)),
      ie(document, ue, $e),
      (ke = !1));
  }
  function Zt(n, e, t) {
  ...
  function Kt(n, e, t, s, i) {
    ...
    if (t) {
      ...
      if (a)
        try {
          let o = JSON.parse(a.innerText);
          return o != null && o.options && o != null && o.history
            ? Promise.resolve(o)
    ...
    return new Promise((s, i) => {
      Kt(e, t, n.filePath, i, n.production)
        .then((r) => {
          ...
          const a = r.options || {},
            o = qt(n.element) ? n.element : document.getElementById(n.elementId);
          if (!o) {
          ...
          const c = zt(r.history, h, Zt(o, l, d)),
            u = new $t({
              id: h,
              fps: n.fps || a.fps || 60,
              dpi: d,
          ...
          ((u.curtain.canvas.innerText = n.altText || ''),
            u.curtain.canvas.setAttribute('aria-label', n.ariaLabel || 'Unicorn Studio Scene'),
            u.curtain.canvas.setAttribute('role', 'img'));
          let f = a[ge('ZnJlZVBsYW4=')];
          ((f || a[ge('aW5jbHVkZUxvZ28=')]) && Lt(h, o),
            f && console.log(ge('TWFkZSB3aXRoIHVuaWNvcm4uc3R1ZGlv')),
            S.push(u),
            (u.layers = c),
            u.preloadTextures(),
            u.setInteractiveParams(n, a),
            (u.isInView = u.isFixed || qe(u.element, u.bbox, 50)),
            (!u.lazyLoad || u.isInView) && u.initializePlanes(),
            ke || Qt(),
            s(u));
        })
        .catch((r) => {
    ...
    return es()
      ? new Promise((n, e) => {
          ...
          t.filter((i) => !i.getAttribute('data-us-initialized')).forEach((i, r) => {
            (i.setAttribute('data-us-initialized', !0),
              s(() => {
                const a = Y(i, 'data-us-project'),
                  o = Y(i, 'data-us-project-src'),
                  h = Y(i, 'data-us-disablemobile'),
                ...
                Je({
                  ...
                  interactivity: h || l ? { mouse: { disableMobile: h, disabled: l } } : null,
                }).then((d) => {
                  r === t.length - 1 && n(S);
                });
              }));
      ...
      : (console.warn(
          'WebGL2 is not supported in this browser. Unicorn Studio initialization skipped.',
        ),
        Promise.resolve([]));
  }
  ((I.addScene = Je),
